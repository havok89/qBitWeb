...
- **Auto-Update Notifications**: Automatically checks for new versions of qBitWeb in the background and displays a notification banner so you never miss a release.
